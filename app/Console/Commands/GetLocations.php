...
class GetLocations extends Command
{
     ...
     * @var string
     */
    protected $signature = 'lyft:locations';
     ...
     * @var string
     */
    protected $description = 'This command call the lyft api and get the geo locations of drivers';
    ...
    public function handle()
    {
        ...
        $myFile = "public/data/data.txt";
        $fh = fopen($myFile, 'a') or die("can't open file");
        $stringData = "\n//" . Carbon::now()->toDayDateTimeString() . "\n";
        fwrite($fh, $stringData);
        fwrite($fh, $locations);
        fclose($fh);
        $this->info('The driver locations were saved successfully!');
    }
